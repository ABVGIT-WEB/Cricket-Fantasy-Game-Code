...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Team Points Available"))
        self.label_7.setText(_translate("MainWindow", " Team Points Used"))
        ...
        self.label_5.setText(_translate("MainWindow", "Please check Your selections"))
        self.label_5.setText(_translate("MainWindow", "Your Team Selection"))
        ...
        self.menuManage_Teams.setTitle(_translate("MainWindow", "Manage Your Teams"))
    ...
    def exit(self):                                                             #its function is to exit the program when exit button is pressed
        import sys
        self.sd("Thank you for using Fantasy Cricket")
        sys.exit()
